...
function overview_template_controller_push(location, weatherDescription, currentTemperature, WEATHER_TYPE) {
    ...
    $('.weatherInformation').toggleClass('fadeInUp');

}

function suggestion_template_controller_push(oberteilArray, unterteilArray, schuhArray, spezialArray) {

    //Prepares Template for displaying suggestion template
    $('.site-wrap').toggleClass('disable-scroll');
    $('.loader').toggleClass('fadeOut');
    $('.arrow').toggleClass('fadeIn');
    ...
    $('.suggestiontext').before('<p class="h4">Empfehlung</p>');
    ...
    var swiperOberteile = new Swiper('.swiper-oberteile', {
